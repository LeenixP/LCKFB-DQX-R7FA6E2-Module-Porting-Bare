...
const gpt_extended_cfg_t g_timer1_extend =
		{
				.gtioca = { .output_enabled = true, .stop_level =
						GPT_PIN_LEVEL_HIGH }, .gtiocb = { .output_enabled =
						false, .stop_level = GPT_PIN_LEVEL_LOW },
...
/* Actual period: 0.02 seconds. Actual duty: 0%. */.period_counts =
		(uint32_t) 0xf424, .duty_cycle_counts = 0x0, .source_div =
		(timer_source_div_t) 5, .channel = 1, .p_callback = NULL,

...
#ifndef BSP_CODE_BSP_MQ5_H_
#define BSP_CODE_BSP_MQ5_H_
...
int Get_Adc_MQ5_Value(void);
int Get_MQ5_Percentage_value(void);
char Get_MQ5_DO(void);

#endif /* BSP_CODE_BSP_MQ5_H_ */

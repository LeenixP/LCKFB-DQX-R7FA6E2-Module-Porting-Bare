...
#ifndef BSP_CODE_BSP_MQ135_H_
#define BSP_CODE_BSP_MQ135_H_
...
int Get_Adc_MQ135_Value(void);
int Get_MQ135_Percentage_value(void);
char Get_MQ135_DO(void);

#endif /* BSP_CODE_BSP_MQ135_H_ */

...
#ifndef BSP_CODE_BSP_SHT20_H_
#define BSP_CODE_BSP_SHT20_H_
...
#define SHT20_TEMP_REG_ADDR     0xF3    // 温度
#define SHT20_HUMI_REG_ADDR     0xF5    // 湿度

void SHT20_Init(void);
char SHT20_Read(uint8_t regaddr, float *sht20_value);

#endif /* BSP_CODE_BSP_SHT20_H_ */

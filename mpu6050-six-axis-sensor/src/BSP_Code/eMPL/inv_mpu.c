...
#define MOTION_DRIVER_TARGET_MSP430		//定义驱动部分,采用MSP430的驱动
...
extern char MPU6050_WriteReg(uint8_t addr,uint8_t regaddr,uint8_t num,uint8_t *regdata);
extern char MPU6050_ReadData(uint8_t addr, uint8_t regaddr,uint8_t num,uint8_t* Read);

...
/******************************************************************
 * 函 数 名 称：Get_MQ7_Percentage_value
 * 函 数 说 明：读取MQ7值，并且返回百分比
 * 函 数 形 参：无
 * 函 数 返 回：返回百分比
 * 作       者：LCKFB
 * 备       注：无
******************************************************************/
int Get_MQ7_Percentage_value(void)
{
      int adc_max = 4095;
      int adc_new = 0;
      int Percentage_value = 0;

      adc_new = Get_Adc_MQ7_Value();

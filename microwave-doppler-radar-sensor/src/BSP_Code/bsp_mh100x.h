...
#define BSP_Module_GPIO_OUT_PIN		BSP_IO_PORT_04_PIN_03

static inline bsp_io_level_t OUT_IN(void) {
    bsp_io_level_t p_pin_value;
    fsp_err_t err = R_IOPORT_PinRead(&g_ioport_ctrl, BSP_Module_GPIO_OUT_PIN, &p_pin_value);
    if(err != FSP_SUCCESS)
    {

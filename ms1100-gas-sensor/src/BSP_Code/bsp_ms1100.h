...
#ifndef BSP_CODE_BSP_MS1100_H_
#define BSP_CODE_BSP_MS1100_H_
...
static inline bsp_io_level_t MS1100_DO(void) {
...
void MS1100_Init(void);//MS1100初始化
int Get_MS1100_Value(void);//读取AO值
uint8_t Get_DO_Num(void);//读取DO值

#endif /* BSP_CODE_BSP_MS1100_H_ */

...
#ifndef BSP_CODE_BSP_SOILHUMIDITY_H_
#define BSP_CODE_BSP_SOILHUMIDITY_H_
...
static inline bsp_io_level_t Module_DO(void) {
...
uint8_t Get_SH_Percentage_value(void);
char Get_SH_DO_value(void);

#endif /* BSP_CODE_BSP_SOILHUMIDITY_H_ */
